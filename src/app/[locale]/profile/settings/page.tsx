            ...
            <p className="text-xs text-gray-600 mt-1">
              ...
              {bio.trim().length > 0 && bio.trim().length < 20 && (
                <span className="text-[#FFD700] ml-2">
                  {zh ? `还需 ${20 - bio.trim().length} 字` : locale === "es" ? `Faltan ${20 - bio.trim().length}` : locale === "fr" ? `Encore ${20 - bio.trim().length}` : `${20 - bio.trim().length} more needed`}
                </span>
              )}
            </p>
          </div>
          ...
          <div className="bg-[#0F2040] border border-[#1E3A5F] rounded-2xl p-5">
            ...
            <p className="text-xs text-gray-600 mt-1">
              ...
              {slogan.trim().length > 0 && slogan.trim().length < 10 && (
                <span className="text-[#FFD700] ml-2">
                  {zh ? `还需 ${10 - slogan.trim().length} 字` : locale === "es" ? `Faltan ${10 - slogan.trim().length}` : locale === "fr" ? `Encore ${10 - slogan.trim().length}` : `${10 - slogan.trim().length} more needed`}
                </span>
              )}
            </p>
          </div>
