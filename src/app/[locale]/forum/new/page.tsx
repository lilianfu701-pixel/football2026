    ...
    <div className="min-h-screen bg-[#0A1628] text-white pb-20">
      <div className="pt-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <span className="text-white">{lc(locale, "发新帖", "New Post")}</span>
        </div>

        <div className="mb-6">
          <h1 className="text-2xl font-black text-white">✏️ {lc(locale, "发新帖", "New Post")}</h1>
          <p className="text-gray-500 text-sm mt-1">
            {lc(locale, "分享你的观点，参与讨论", "Share your thoughts and join the discussion")}
          </p>
        </div>
          ...
          {fromLockedBoard ? (
            ...
            <div className="text-center py-10 space-y-4">
              ...
              <h2 className="text-lg font-black text-white">
                {lc(locale, "此板块为系统专属", "This board is for official posts only")}
              </h2>
              <p className="text-sm text-gray-500 max-w-sm mx-auto">
                {lc(locale, "赛事讨论板块的帖子由系统自动生成，用户无法在此发帖。请选择其他板块参与讨论。", "Match threads are created automatically. Please choose another board.")}
              </p>
              <div className="flex justify-center gap-3 pt-2">
                ...
                >
                  {lc(locale, "选择其他板块发帖", "Post in another board")}
                </Link>
              </div>
            </div>
          ) : (
