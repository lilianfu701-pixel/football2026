  ...
  return (
    <>
      ...
      <button
        onClick={handleClick}
        disabled={loading}
        className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg font-semibold border transition-all shrink-0 disabled:opacity-50 ${
          following
